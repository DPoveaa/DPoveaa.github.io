  ...
  return (
    <div className="container mx-auto px-4 py-20">
      ...
      <div className={`rounded-xl overflow-hidden shadow-2xl mb-10 ${
        ...
        <div className="relative h-[600px] bg-black/5">
          {images && images.length > 0 ? (
            <>
              {(() => {
                ...
                } else if (current.toLowerCase().endsWith('.mp4')) {
                  return (
                    <video
                      src={current}
                      controls
              ...
              {images.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-4 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-black/50 text-white hover:bg-black/70 z-10"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 transform -translate-y-1/2 p-2 rounded-full bg-black/50 text-white hover:bg-black/70 z-10"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
